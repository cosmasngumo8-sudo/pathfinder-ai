  ...
  "rounded-xl border bg-card text-card-foreground",
  {
    variants: {
      variant: {
        ...
        glass: "glass-card",
        gradient: "bg-gradient-to-br from-white to-secondary/30 shadow-card",
        outline: "border-2 shadow-none",
        stat: "stat-card shadow-card hover:shadow-xl",
        premium: "border-2 border-amber-200 bg-gradient-to-br from-amber-50 to-white shadow-lg",
        ...
        danger: "border-rose-200 bg-gradient-to-br from-rose-50 to-white",
      },
    },
    defaultVariants: {
      variant: "default",
